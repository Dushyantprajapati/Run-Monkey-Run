...
function setup() {
  ...
  player = createSprite(100,600,20,50);
...
function draw() {
  ...
  switch(score){
    ...
    case 40:player.scale=0.20;
       break; 
    case 50:player.scale=0.22;
       break;
    case 60:player.scale=0.25;  
       break;
    case 70:player.scale=0.27;
       break;
    case 80:player.scale=0.30;
       break;
...
function spawnObstacles() {
  if(frameCount % 100 === 0) {
    var obstacle = createSprite(800,610,10,40);
